...
package Interfaces.LPC43.USART is
   ...
   subtype RBR_RBR_Field is Interfaces.LPC43.Byte;
   subtype RBR_RESERVED_Field is Interfaces.LPC43.UInt24;
   ...
   subtype THR_THR_Field is Interfaces.LPC43.Byte;
   subtype THR_RESERVED_Field is Interfaces.LPC43.UInt24;
   ...
   subtype DLL_DLLSB_Field is Interfaces.LPC43.Byte;
   subtype DLL_RESERVED_Field is Interfaces.LPC43.UInt24;
   ...
   subtype DLM_DLMSB_Field is Interfaces.LPC43.Byte;
   subtype DLM_RESERVED_Field is Interfaces.LPC43.UInt24;
   ...
   subtype IER_RESERVED_Field is Interfaces.LPC43.Bit;
   subtype IER_RESERVED_Field_1 is Interfaces.LPC43.UInt3;
   subtype IER_RESERVED_Field_2 is Interfaces.LPC43.UInt22;
   ...
   type IER_Register is record
      ...
      RXIE       : IER_ENUM := Interfaces.LPC43.USART.Disable;
      --  Reserved
      ...
      ABEOINTEN  : IER_ENUM := Interfaces.LPC43.USART.Disable;
      --  Enables the auto-baud time-out interrupt.
      ABTOINTEN  : IER_ENUM := Interfaces.LPC43.USART.Disable;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   subtype IIR_RESERVED_Field is Interfaces.LPC43.UInt2;
   subtype IIR_FIFOENABLE_Field is Interfaces.LPC43.UInt2;
   subtype IIR_ABEOINT_Field is Interfaces.LPC43.Bit;
   subtype IIR_ABTOINT_Field is Interfaces.LPC43.Bit;
   subtype IIR_RESERVED_Field_1 is Interfaces.LPC43.UInt22;
   ...
   subtype FCR_DMAMODE_Field is Interfaces.LPC43.Bit;
   subtype FCR_RESERVED_Field is Interfaces.LPC43.UInt2;
   ...
   subtype FCR_RESERVED_Field_1 is Interfaces.LPC43.UInt24;

   --  FIFO Control Register. Controls USART FIFO usage and modes.
   type FCR_Register is record
      --  Write-only. FIFO Enable.
      FIFOEN     : FCR_ENUM := Interfaces.LPC43.USART.Disabled;
      --  Write-only. RX FIFO Reset.
      RXFIFORES  : FCR_ENUM_1 := Interfaces.LPC43.USART.No_Effect;
      --  Write-only. TX FIFO Reset.
      TXFIFORES  : FCR_ENUM_1 := Interfaces.LPC43.USART.No_Effect;
      ...
      --  activated.
      RXTRIGLVL  : FCR_ENUM_2 := Interfaces.LPC43.USART.Level_0;
      --  Write-only. Reserved
   ...
   subtype LCR_RESERVED_Field is Interfaces.LPC43.UInt24;
   ...
   type LCR_Register is record
      --  Word Length Select.
      WLS      : LCR_ENUM :=
                  Interfaces.LPC43.USART.LCR_ENUM_5_Bit_Character_Leng;
      --  Stop Bit Select.
      SBS      : LCR_ENUM_1 := Interfaces.LPC43.USART.LCR_ENUM_1_Stop_Bit;
      --  Parity Enable
      PE       : LCR_ENUM_2 := Interfaces.LPC43.USART.Disable_Parity_Gener;
      --  Parity Select.
      PS       : LCR_ENUM_3 := Interfaces.LPC43.USART.Odd_Parity;
      --  Break Control.
      BC       : LCR_ENUM_4 := Interfaces.LPC43.USART.Disabled;
      --  Divisor Latch Access Bit.
      DLAB     : LCR_ENUM_4 := Interfaces.LPC43.USART.Disabled;
      --  Reserved
   ...
   subtype LSR_RESERVED_Field is Interfaces.LPC43.UInt23;
   ...
   subtype SCR_PAD_Field is Interfaces.LPC43.Byte;
   subtype SCR_RESERVED_Field is Interfaces.LPC43.UInt24;
   ...
   subtype ACR_RESERVED_Field is Interfaces.LPC43.UInt5;
   ...
   subtype ACR_RESERVED_Field_1 is Interfaces.LPC43.UInt22;
   ...
   type ACR_Register is record
      ...
      --  completion.
      START       : ACR_ENUM := Interfaces.LPC43.USART.Stop;
      --  Auto-baud mode select bit.
      MODE        : ACR_ENUM_1 := Interfaces.LPC43.USART.Mode_0;
      --  Restart bit.
      AUTORESTART : ACR_ENUM_2 := Interfaces.LPC43.USART.No_Restart;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
      RESERVED    : ACR_RESERVED_Field := 16#0#;
      --  End of auto-baud interrupt clear bit (write-only).
      ABEOINTCLR  : ACR_ENUM_3 := Interfaces.LPC43.USART.No_Effect;
      --  Auto-baud time-out interrupt clear bit (write-only).
      ABTOINTCLR  : ACR_ENUM_3 := Interfaces.LPC43.USART.No_Effect;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   subtype ICR_PULSEDIV_Field is Interfaces.LPC43.UInt3;
   subtype ICR_RESERVED_Field is Interfaces.LPC43.UInt26;

   --  IrDA control register (USART3 only)
   type ICR_Register is record
      --  IrDA mode enable.
      IRDAEN     : ICR_ENUM := Interfaces.LPC43.USART.Disabled;
      --  Serial input direction.
      IRDAINV    : ICR_ENUM_1 := Interfaces.LPC43.USART.Not_Inverted;
      --  IrDA fixed pulse width mode.
      FIXPULSEEN : ICR_ENUM := Interfaces.LPC43.USART.Disabled;
   ...
   subtype FDR_DIVADDVAL_Field is Interfaces.LPC43.UInt4;
   subtype FDR_MULVAL_Field is Interfaces.LPC43.UInt4;
   subtype FDR_RESERVED_Field is Interfaces.LPC43.UInt24;
   ...
   subtype OSR_RESERVED_Field is Interfaces.LPC43.Bit;
   subtype OSR_OSFRAC_Field is Interfaces.LPC43.UInt3;
   subtype OSR_OSINT_Field is Interfaces.LPC43.UInt4;
   subtype OSR_FDINT_Field is Interfaces.LPC43.UInt7;
   subtype OSR_RESERVED_Field_1 is Interfaces.LPC43.UInt17;
   ...
   subtype HDEN_RESERVED_Field is Interfaces.LPC43.UInt31;

   --  Half-duplex enable Register
   type HDEN_Register is record
      --  Half-duplex mode enable
      HDEN     : HDEN_ENUM := Interfaces.LPC43.USART.Disabled;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   subtype SCICTRL_RESERVED_Field is Interfaces.LPC43.UInt2;
   subtype SCICTRL_TXRETRY_Field is Interfaces.LPC43.UInt3;
   subtype SCICTRL_GUARDTIME_Field is Interfaces.LPC43.Byte;
   subtype SCICTRL_RESERVED_Field_1 is Interfaces.LPC43.UInt16;

   --  Smart card interface control register
   type SCICTRL_Register is record
      --  Smart Card Interface Enable.
      SCIEN      : SCICTRL_ENUM := Interfaces.LPC43.USART.Disabled;
      --  NACK response disable. Only applicable in T=0.
      NACKDIS    : SCICTRL_ENUM_1 := Interfaces.LPC43.USART.Enabled;
      --  Protocol selection as defined in the ISO7816-3 standard.
      PROTSEL    : SCICTRL_ENUM_2 := Interfaces.LPC43.USART.T_Eq_0;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   subtype RS485CTRL_RESERVED_Field is Interfaces.LPC43.Bit;
   ...
   subtype RS485CTRL_RESERVED_Field_1 is Interfaces.LPC43.UInt26;
   ...
   type RS485CTRL_Register is record
      --  NMM enable.
      NMMEN      : RS485CTRL_ENUM := Interfaces.LPC43.USART.Disabled;
      --  Receiver enable.
      RXDIS      : RS485CTRL_ENUM_1 := Interfaces.LPC43.USART.Enabled;
      --  AAD enable
      AADEN      : RS485CTRL_ENUM := Interfaces.LPC43.USART.Disabled;
      --  Reserved.
      RESERVED   : RS485CTRL_RESERVED_Field := 16#0#;
      --  Direction control for DIR pin.
      DCTRL      : RS485CTRL_ENUM := Interfaces.LPC43.USART.Disabled;
      --  Direction control pin polarity. This bit reverses the polarity of the
      --  direction control signal on the DIR pin.
      OINV       : RS485CTRL_ENUM_2 := Interfaces.LPC43.USART.Low;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   subtype RS485ADRMATCH_ADRMATCH_Field is Interfaces.LPC43.Byte;
   subtype RS485ADRMATCH_RESERVED_Field is Interfaces.LPC43.UInt24;
   ...
   subtype RS485DLY_DLY_Field is Interfaces.LPC43.Byte;
   subtype RS485DLY_RESERVED_Field is Interfaces.LPC43.UInt24;
   ...
   subtype SYNCCTRL_RESERVED_Field is Interfaces.LPC43.UInt25;

   --  Synchronous mode control register.
   type SYNCCTRL_Register is record
      --  Enables synchronous mode.
      SYNC     : SYNCCTRL_ENUM := Interfaces.LPC43.USART.Disabled;
      --  Clock source select.
      CSRC     : SYNCCTRL_ENUM_1 := Interfaces.LPC43.USART.Slave_Mode;
      --  Edge sampling.
      FES      : SYNCCTRL_ENUM_2 := Interfaces.LPC43.USART.Rising;
      --  Transmit synchronization bypass in synchronous slave mode.
      TSBYPASS : SYNCCTRL_ENUM_3 := Interfaces.LPC43.USART.Synchronized_k;
      --  Continuous master clock enable (used only when CSRC is 1)
      CSCEN    : SYNCCTRL_ENUM_4 := Interfaces.LPC43.USART.On_Character;
      --  Start/stop bits
      SSSDIS   : SYNCCTRL_ENUM_5 := Interfaces.LPC43.USART.Send;
      --  Continuous clock clear
      CCCLR    : SYNCCTRL_ENUM_6 := Interfaces.LPC43.USART.Software;
   ...
   subtype TER_TXEN_Field is Interfaces.LPC43.Bit;
   subtype TER_RESERVED_Field is Interfaces.LPC43.UInt31;
